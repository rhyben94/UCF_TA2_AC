...
Medic_TriageSuccessful_UpperThreshold_List = [5, 6, 7, 7, 7]
Medic_TriageSuccessful_LowerThreshold_List = [3, 4, 4, 4, 4]

Medic_TriageSuccessful_to_MovementRatio_UpperThreshold_List = [0.014, 0.014, 0.014, 0.014, 0.014]
Medic_TriageSuccessful_to_MovementRatio_LowerThreshold_List = [0.011, 0.011, 0.011, 0.011, 0.011]

Medic_Transport_Distance_Average_UpperThreshold_List = [4, 4, 4, 5, 5]
Medic_Transport_Distance_Average_LowerThreshold_List = [2, 2, 2, 2, 2]

Medic_TriageSuccessful_to_Transports_ratio_UpperThreshold_List = [2, 2, 2, 2, 2]
Medic_TriageSuccessful_to_Transports_ratio_LowerThreshold_List = [1.3, 1, 1, 1, 1]

Medic_Transports_Completed_Count_UpperThreshold_List = [4, 4, 4, 4, 4]
Medic_Transports_Completed_Count_LowerThreshold_List = [2, 2, 2, 2, 2]

Engineer_RubbleDestroyed_Count_UpperThreshold_List = [12, 12, 12, 12, 16]
Engineer_RubbleDestroyed_Count_LowerThreshold_List = [6, 6, 6, 6, 10]

Engineer_RubbleDestroyed_to_MovementRatio_UpperThreshold_List = [.03, .03, .04, .04, .045]
Engineer_RubbleDestroyed_to_MovementRatio_LowerThreshold_List = [.02, .02, .02, .02, .03]
...
Engineer_Rubble_to_Transports_ratio_LowerThreshold_List = [3, 3, 3, 3, 3]
...
Transporter_Transport_Distance_Average_UpperThreshold_List = [.6, .7, .7, .8, .8]
Transporter_Transport_Distance_Average_LowerThreshold_List = [.4, .4, .4, .4, .4]
